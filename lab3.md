...
### Xác dịnh các phần tử thiết kế của hệ thống "Payroll System"
 # **BankSystem**
 #### Hệ thống con BankSystem là hệ thống Payroll System  với mục đích xử lý các giao dịch tài chính liên quan đến việc trả lương cho nhân viên.
...
### Phương thức 
- ### processPayment(aInstruction: PaymentInstruction): Xử lý các thanh toán chỉ định từ các hệ thống khác.
...
- #### getProjectInfo(projectId: String): ProjectData
  - #### Mô tả: Truy vấn thông tin dự án dựa trên mã dự án projectId. - #### Đầu vào: projectId (String)
